...
export function ProductSection() {
  ...
  return <section id="forum" className="py-24 bg-sa-cream">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          duration: 0.6
            ...
            <div className="bg-sa-beige p-8 rounded-2xl border border-sa-brown/5">
              <h3 className="font-serif text-2xl text-sa-brown mb-6">
                The Commitment
              </h3>
          ...
          delay: 0.2
            ...
            <div className="relative z-10">
              <h3 className="font-serif text-3xl text-sa-brown mb-8">
                The Experience
              </h3>
