...
export function ApplicationProcess() {
  ...
  return <section id="apply" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          <h2 className="font-serif text-4xl md:text-5xl text-sa-brown mb-6">
            How to Join
          </h2>
          <p className="text-lg text-sa-brown/70 max-w-2xl mx-auto">
        ...
        <div className="grid md:grid-cols-4 gap-8 relative">
          ...
          delay: index * 0.1
              ...
              <div className="w-16 h-16 bg-sa-beige rounded-full flex items-center justify-center text-sa-terracotta font-serif text-2xl font-bold mb-6 mx-auto md:mx-0 border-4 border-white">
                {step.number}
              </div>
              <h3 className="font-serif text-xl text-sa-brown font-bold mb-3 text-center md:text-left">
                {step.title}
              </h3>
              <p className="text-sa-brown/70 text-sm leading-relaxed text-center md:text-left">
                {step.desc}
              </p>
            </motion.div>)}
        </div>
        ...
        <div className="mt-20 text-center">
          <div className="inline-block p-1 rounded-full bg-gradient-to-r from-sa-terracotta to-sa-sage">
            <a href="#" className="block px-12 py-4 bg-white rounded-full text-sa-brown font-bold text-lg hover:bg-transparent hover:text-white transition-all duration-300">
